            ...
            try
            {
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity targetEntity)
                {
                    if (targetEntity.LogicalName == "contact")
                    {
                        ...
                        if (contactEntity.ContainsData("stt_enterpriseid"))
                        {
                        ...
                        Entity contactToUpdate = service.Retrieve("contact", contactId, new ColumnSet("stt_enterpriseid"));
                        ...
                        if (existingResults.Entities.Count > 0)
                        {
                            ...
                            if (contactToUpdate["stt_enterpriseid"] == null && existingEnterpriseContactAutoNumber.Contains("stt_enterpriseid") && existingEnterpriseContactAutoNumber["stt_enterpriseid"] != null)
                            {
